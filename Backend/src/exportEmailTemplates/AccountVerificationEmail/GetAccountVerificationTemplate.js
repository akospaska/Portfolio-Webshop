...
const getAccountVerificationTemplate = (sessionKey) => {
                                                          ...
                                                          >
                                                            <div>
                                                              <div style="font-family: inherit; text-align: center">
                                                                <span style="font-size: 43px">Account register confirmation</span>
                                                              </div>
                                                              <div></div>
                                                            </div>
                                                          </td>
                                                    ...
                                                    >
                                                      <tbody>
                                                        <tr>
                                                          ...
                                                          >
                                                            <a
                                                              href="${getRootUrl()}api/accountverification?sessionKey=${sessionKey}"
                                                              
                                                              height="100%"
                                                              valign="top"
                                                              bgcolor="#ffffff"
                                                              role="module-content"
                                                              >Confirm your registration here!</a
                                                            >
                                                          </td>
                                                        </tr>
                                                      </tbody>
...
module.exports = getAccountVerificationTemplate;
